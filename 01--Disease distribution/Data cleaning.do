...
merge 1:1 csid using "D:\HanYT\2020-01 Data Review for HuYZ\主分析数据库\data_baseline_questionnaires.dta", keepusing(met tv_reading_hours) nogen
rename csid studyid
...
***diet
*需要单独分析饮食指标，在理论基础上选择有意义的；咱按照楠波师兄定义10-25
...
egen healthy_PA = rowmin(healthy_PA1 healthy_PA2 healthy_PA3 healthy_PA4 healthy_PA5 healthy_PA6)
	...
	label define healthy_PA 1 "PA level higher half" 0 "PA level lower half"
...
egen healthy_score = rowtotal(healthy_smoking healthy_alcohol healthy_PA healthy_diet healthy_obesity healthy_sleep)
recode healthy_score (0/1=0) (2=1) (3=2) (4=3) (5=4) (6=5), gen(healthy_score_6groups)
...
use "D:\HanYT\2019-06 Multimorbidity\1. Database\basic database.dta", clear
drop if mi(bmi_calc)
drop if studyid == 5517590    /* 0509 入组即失访者 */
