...
cd "D:\HanYT\2021-02 CMM to death"
...
export excel using "2. Result\Cohort characteristics\Baseline characteristics male disease number $S_DATE.xlsx", firstrow(var) replace
...
cap mkdir "2. Result\Cohort characteristics"
export excel using "2. Result\Cohort characteristics\Baseline characteristics female disease number $S_DATE.xlsx", firstrow(var) replace
...
cap mkdir "2. Result\Cohort characteristics"
export excel using "2. Result\Cohort characteristics\Baseline characteristics male disease combination $S_DATE.xlsx", firstrow(var) replace
...
***** Number of participants
tabstat is_female, s(count) by(combin_base) save
post `stats' ("No.") ("") ("`r(Stat1)[1,1]'") ("`r(Stat2)[1,1]'") ("`r(Stat3)[1,1]'") ("`r(Stat4)[1,1]'") ("`r(Stat5)[1,1]'") ("`r(Stat6)[1,1]'") ///
	("`r(Stat7)[1,1]'") ("`r(Stat8)[1,1]'") ("`r(StatTotal)[1,1]'") 
...
cap mkdir "2. Result\Cohort characteristics"
export excel using "2. Result\Cohort characteristics\Baseline characteristics female disease combination $S_DATE.xlsx", firstrow(var) replace
