********************************************
* Objective: Sensitivity analysis ----- addditionally adjusted for hypertension-lowering and blood glucuse-lowering medicine
* Version 1
...
/* 设置全局宏 */
*** Covariates for adjustment; Plus has_hypertension
global adjusted_model i.is_female i.highest_education i.household_income i.marital_status i.mltmbd_fh_3groups i.smoking_5groups i.alcohol_7groups i.diet_5score i.bmi_4groups ///
	i.WC_3groups i.PA_5groups i.has_hypertension i.kidney_dis_diag i.rheum_heart_dis_diag i.hypertension_lowering_2g i.glucose_lowering_2groups
...
export delim using "2.Result/HRs//$S_DATE//`ep' Sensitivity adj medicine $S_DATE.csv", replace
