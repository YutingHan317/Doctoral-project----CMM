...
* Version 3
* Created date: 2021/9/13
* Updating log:
/// Version 1-2
* 2021/08/09 st splitting every 0.5 year instead of 1 year
* 2021/08/18 use file was changed
/// Version 3
* 2021/09/13 only use 8groups
* 2021/09/17 adding subgroup analysis
/// Version 4
* 2021/10/29 adding incident disease; drop subgroup analysis
...
*** Exporsure
global exposure_var1 duration_fcmd_8g
global exposure_var2 duration_cmm_8g
global exposure_var3 duration_fcmd_8g duration_cmm_8g
global exposure_var4 duration_fcmd_updated_8g
global exposure_var5 duration_cmm_updated_8g
global exposure_var6 duration_fcmd_updated_8g duration_cmm_updated_8g
...
export delim using "2.Result/HRs//$S_DATE/temp `ep' baseline_updated duration $S_DATE.csv", replace
...
cap mkdir "2.Result/HRs" 
cap mkdir "2.Result/HRs//$S_DATE" 
export delim using "2.Result/HRs//$S_DATE/temp `ep' indident duration $S_DATE.csv", replace
