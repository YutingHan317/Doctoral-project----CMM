...
*test missing
global eplist_status c_ep0003 c_ep0008 c_ep0009  c_ep0010 c_ep0011 c_ep0047  ///
	c_ep0048 c_ep0301 c_ep0301 c_ep0302  du_ep0001 du_ep0002 du_ep0014 du_ep0032
global eplist_date c_ep0003_date c_ep0008_date c_ep0009_date c_ep0010_date c_ep0011_date c_ep0047_date c_ep0048_date c_ep0301_date c_ep0302_date ///
...
foreach e of local elist{
	...
	* Duration
	gen duration_chd_updated = _t - chd_diag_age if chd_diag == 1 & (_t - chd_diag_age) > 0    // 对于基线就已经患病的人;且日期纪录合理的
		...
		replace duration_chd_updated = _t - (c_ep0003_date - dob_anon)/365.25 if chd_diag == 0 & chd_diag_updated == 1 & ((c_ep0003_date - dob_anon)/365.25) <= _t0
	...
	gen duration_stroke_updated =  _t - stroke_or_tia_diag_age if stroke_or_tia_diag == 1 & (_t - stroke_or_tia_diag_age) > 0 
		...
		replace duration_stroke_updated = _t - (c_ep0010_date - dob_anon)/365.25 if stroke_or_tia_diag == 0 & stroke_diag_updated==1 & ((c_ep0010_date - dob_anon)/365.25) <= _t0
