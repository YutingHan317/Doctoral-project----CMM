********************************************************
*** Objective: Generate table for baseline dsiease interaction 
...
****** Log file
log using "2.Result/Log/Baseline Disease by disease interaction V2.log",replace
...
export delim using "2.Result/HRs//$S_DATE//Baseline DXD interaction `ep' $S_DATE.csv", replace
