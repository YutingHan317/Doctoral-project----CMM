...
*** duration groups
egen duration_chd_groups = cut(duration_chd), at(0(1)20 90) icodes
	replace duration_chd_groups = 99 if duration_chd ==.
egen duration_stroke_groups = cut(duration_stroke), at(0(1)20 90) icodes
	replace duration_stroke_groups = 99 if duration_stroke ==.
egen duration_diabetes_groups = cut(duration_diabetes), at(0(1)20 90) icodes
...
*** Age at diagnosis
gen double age_chd_diag = (c_ep0003_date - dob_anon)/365.25
gen double age_stroke_diag = (c_ep0010_date - dob_anon)/365.25
gen double age_diabetes_diag = (c_ep0101_date - dob_anon)/365.25
...
save "D:\HanYT\2021-02 CMM to death\1. Data\project2_updated.dta",replace
