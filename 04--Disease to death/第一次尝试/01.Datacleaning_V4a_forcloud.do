...
* 2021/09/13 1) define duration_8groups: No 0-1 1-5 5-10 10-15 15-20 20-25 25-30 30-35
* 2021/10/14 1）adding specific cause of death
// Version 5
* 2021/10/14 change updated stroke from I60-61, 63-64 to I60-69 ！！！！！！！！！！
...
* Any stroke （Change I60-61, 63-64 to I60-69 )
rename ep_16525_combined_ep c_ep0010
rename ep_16525_combined_datedeveloped c_ep0010_date
...
*** Duration // 这部分定义duration=0为入组当天患病，对于糖尿病就包括了入组时筛查出来的人。
* 62
...
*** duration 8 groups（这个要核查   // 逻辑为将未患病的人赋值为0，其他的递增
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/* Normal way */
************** c_ep0003 随访期间缺血性心脏病；c_ep0010  随访期间stroke I60-I69; c_ep0101 Diabetes E10-E14
...
foreach e of local elist{
	...
	*** Description
	...
	save "1.Data/project2_updated_`e'"
...
foreach e of local elist{
	...
	* Duration
	gen duration_chd_updated = _t - chd_diag_age if chd_diag == 1 & (_t - chd_diag_age) > 0    // 对于基线就已经患病的人;且日期纪录合理的
		...
		replace duration_chd_updated = _t - (c_ep0003_date - dob_anon)/365.25 if chd_diag == 0 & c_ep0003==1 & ((c_ep0003_date - dob_anon)/365.25) <= _t0
	...
	gen duration_diabetes_updated = _t - diabetes_diag_age if diabetes_diag == 1 & (_t - diabetes_diag_age) > 0
		...
		replace duration_diabetes_updated = _t - (c_ep0101_date - dob_anon)/365.25 if has_diabetes == 0 & c_ep0101 == 1 & (c_ep0101_date - dob_anon)/365.25 <= _t0
	...
	gen duration_stroke_updated =  _t - stroke_or_tia_diag_age if stroke_or_tia_diag == 1 & (_t - stroke_or_tia_diag_age) > 0 
		...
		replace duration_stroke_updated = _t - (c_ep0010_date - dob_anon)/365.25 if stroke_or_tia_diag == 0 & c_ep0010==1 & ((c_ep0010_date - dob_anon)/365.25) <= _t0
