...
export delim using "2.Result/HRs//$S_DATE//`ep' baseline_updated duration $S_DATE nochg.csv", replace
...
cap mkdir "2.Result/HRs" 
cap mkdir "2.Result/HRs//$S_DATE" 
export delim using "2.Result/HRs//$S_DATE//`ep' indident duration $S_DATE nochg.csv", replace
