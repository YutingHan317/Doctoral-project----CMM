...
foreach e of local elist{
	...
	* MI 使用该变量时必须剔除基线患有心脏病的人(MI IS HS!!!!!!!!!!)
...
foreach e of local elist{
	...
	* Duration
	gen double duration_chd_updated = _t - chd_diag_age if chd_diag == 1 & (_t - chd_diag_age) > 0    // 对于基线就已经患病的人;且日期纪录合理的
	...
	gen double duration_MI_updated = _t - chd_diag_age if chd_diag == 1 & (_t - chd_diag_age) > 0    // 对于基线就已经患病的人;且日期纪录合理的
