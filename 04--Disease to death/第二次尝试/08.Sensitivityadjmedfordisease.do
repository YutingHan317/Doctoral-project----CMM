********************************************
* Objective: Sensitivity analysis for duration ----- addditionally adjusted for hypertension-lowering and blood glucuse-lowering medicine
* Version 1
...
global adjusted_model i.is_female i.highest_education i.household_income i.marital_status i.mltmbd_fh_3groups i.smoking_5groups i.alcohol_7groups i.diet_5score i.bmi_4groups i.WC_3groups i.PA_5groups i.has_hypertension i.kidney_dis_diag i.rheum_heart_dis_diag i.hypertension_lowering_2g i.glucose_lowering_2groups


*** Exporsure
global exposure_var1 d_number2_base
global exposure_var2 has_diabetes chd_diag stroke_or_tia_diag
global exposure_var3 combin_base
global exposure_var4 d_number2_updated
...
/* Stset */
*use "D:/HanYT/2021-02_CMMtodeath/1.Data/project2_updated_`ep'_nochg.dta", clear
...
export delim using "2.Result/HRs//$S_DATE//`ep' baseline_updated $S_DATE nochg.csv", replace
	 */
...
*** Exporsure
global exposure_var1 d_number2_updated
global exposure_var2 combin_updated
global exposure_var3 diabetes_diag_updated chd_diag_updated stroke_diag_updated
...
use `IR_data',clear
merge 1:1 _n using `coef_data', nogen keepusing(hr lb ub hr_ci)
cap mkdir "2.Result/Sensitivity" 
cap mkdir "2.Result/Sensitivity//$S_DATE" 
export delim using "2.Result/Sensitivity//$S_DATE/Sens med `ep' incident $S_DATE nochg.csv", replace
