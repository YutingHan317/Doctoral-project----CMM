********************************************
* Objective: Sensitivity analysis ----- Excluding participants who died in the first two years of follow-up
* Version 2
...
export delim using "2.Result/Sensitivity//$S_DATE/Sens drop2y `ep' incident $S_DATE.csv", replace
