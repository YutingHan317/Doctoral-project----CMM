...
// Version 3
* 2021/11/24 using d_number2 instead of d_number
// Version 5
* 2021/12/03: Only keep incident results
...
cap mkdir "2.Result/HRs" 
cap mkdir "2.Result/HRs//$S_DATE" 
export delim using "2.Result/HRs//$S_DATE//`ep' incident $S_DATE nochg.csv", replace
