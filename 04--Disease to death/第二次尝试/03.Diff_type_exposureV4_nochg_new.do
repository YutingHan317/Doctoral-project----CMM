********************************************
* Usage: generating table for three single CMD diseases
* Version 1
...
export delim using "2.Result/HRs//$S_DATE//`ep' `exposure' incident_newdicho $S_DATE.csv", replace
