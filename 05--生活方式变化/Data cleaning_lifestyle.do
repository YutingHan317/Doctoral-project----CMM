...
merge 1:1 studyid using "D:\HanYT\03--生活方式变化\1. Data\endpoints.dta", keep(match) keepusing(c_ep0002 c_ep0002_date ///
	c_ep0003 c_ep0003_date c_ep0070 c_ep0070_date c_ep0009 c_ep0009_date c_ep0014 c_ep0014_date c_ep0033 c_ep0033_date ///
...
local varlist dob_anon study_date censoring_date c_ep0002_date c_ep0003_date c_ep0070_date c_ep0009_date c_ep0014_date ///
...
***生成基线与第二次随访期间出现的结局
local endpoints c_ep0001 c_ep0002 c_ep0003 c_ep0070 c_ep0009 c_ep0014 c_ep0033 c_ep0088
...
* 出现心血管代谢性共病(2型糖尿病、缺血性脑卒中、缺血性心脏病)
egen cmd_number_d = rowtotal(c_ep0003_d c_ep0009_d c_ep0088_d)
