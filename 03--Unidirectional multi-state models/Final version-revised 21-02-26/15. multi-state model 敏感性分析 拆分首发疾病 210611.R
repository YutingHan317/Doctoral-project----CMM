...
phrases <- c("study_date","first_cmd_inc","first_cmd_inc_date","mltmbd_inc","mltmbd_inc_date","du_ep0001","du_ep0001_date",
             "c_ep0003","c_ep0003_date","c_ep0008","c_ep0008_date","c_ep0009","c_ep0009_date","c_ep0088","c_ep0088_date","d_number_inc3")
...
# 仅保留需要的变量
mltstate.origin.split <- subset(project4.split, select = varlist, sametime == 0)  
# 生成代表进入研究的阶段
