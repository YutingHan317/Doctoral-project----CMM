...
project4.graph$first_cmd_inc_date <- as.numeric(project4.graph$first_cmd_inc_date1)
project4.graph$mltmbd_inc_date <- as.numeric(project4.graph$mltmbd_inc_date1)
...
project4.graph$first_cmd_inc <- as.numeric(project4.graph$first_cmd_inc1)
project4.graph$mltmbd_inc <- as.numeric(project4.graph$mltmbd_inc1)
...
ggsave("Transition plot1.tiff",path = path_transplot,width = 9,height = 9)
...
ggsave("Transition plot2.tiff",path = path_transplot,width = 9,height = 9)




write.csv(pt3[[1]], "D:/HanYT/2019-06 Multimorbidity/3. Result/multistate/Figure/2021-03-07/transition 0-1.csv")
write.csv(pt4[[1]], "D:/HanYT/2019-06 Multimorbidity/3. Result/multistate/Figure/2021-03-07/transition 5.csv")
