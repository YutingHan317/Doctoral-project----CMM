...
project4sens$first_cmd_inc_date <- as.numeric(project4sens$first_cmd_inc_date1)
project4sens$mltmbd_inc_date <- as.numeric(project4sens$mltmbd_inc_date1)
project4sens$du_ep0001_date <- as.numeric(project4sens$du_ep0001_date)
project4sens$dob_anon <- as.numeric(project4sens$dob_anon)

project4sens$first_cmd_inc <- as.numeric(project4sens$first_cmd_inc1)
project4sens$mltmbd_inc <- as.numeric(project4sens$mltmbd_inc1)
