...
project4.split$first_cmd_inc_date <- as.numeric(project4.split$first_cmd_inc_date3)
# 
...
project4.split$mltmbd_inc_date <- as.numeric(project4.split$mltmbd_inc_date3)
...
project4.split$first_cmd_inc <- as.numeric(project4.split$first_cmd_inc3)
project4.split$mltmbd_inc <- as.numeric(project4.split$mltmbd_inc3)

# 一、某些研究对象首次心血管代谢性疾病发生于2017年12月31日，在上述基础上加上0.5天
attach(project4.split)
project4.split$mltmbd_inc_date[first_cmd_inc==1&mltmbd_inc==0&du_ep0001==0&first_cmd_inc_date==as.numeric(as.Date("31/12/17", "%d/%m/%y"))] <- project4.split$mltmbd_inc_date[first_cmd_inc==1&mltmbd_inc==0&du_ep0001==0&first_cmd_inc_date==as.numeric(as.Date("31/12/17", "%d/%m/%y"))] + 0.5
...
# # 增加考虑首发疾病 21/2/22
attach(project4.split)
project4.split$sametime.fcmd[(d_number_inc3==2&c_ep0003==1&c_ep0008==1&c_ep0003_date==c_ep0008_date) |
                             (d_number_inc3==2&c_ep0003==1&c_ep0009==1&c_ep0003_date==c_ep0009_date) |
                             (d_number_inc3==2&c_ep0003==1&c_ep0088==1&c_ep0003_date==c_ep0088_date) |
                             (d_number_inc3==2&c_ep0009==1&c_ep0008==1&c_ep0009_date==c_ep0008_date) |
                             (d_number_inc3==2&c_ep0009==1&c_ep0088==1&c_ep0009_date==c_ep0088_date) |
                             (d_number_inc3==2&c_ep0008==1&c_ep0088==1&c_ep0008_date==c_ep0088_date) |
                             (d_number_inc3==3&c_ep0003==1&c_ep0008==1&c_ep0009==1&c_ep0003_date==c_ep0008_date&c_ep0008_date==c_ep0009_date) |
                             (d_number_inc3==3&c_ep0003==1&c_ep0008==1&c_ep0088==1&c_ep0003_date==c_ep0008_date&c_ep0008_date==c_ep0088_date) |
                             (d_number_inc3==3&c_ep0003==1&c_ep0009==1&c_ep0088==1&c_ep0003_date==c_ep0009_date&c_ep0009_date==c_ep0088_date) |
                             (d_number_inc3==3&c_ep0008==1&c_ep0009==1&c_ep0088==1&c_ep0008_date==c_ep0009_date&c_ep0009_date==c_ep0088_date) |
                             (d_number_inc3==4&c_ep0003==1&c_ep0008==1&c_ep0009==1&c_ep0088==1&c_ep0003_date==c_ep0008_date&
                              c_ep0008_date==c_ep0009_date&c_ep0009_date==c_ep0088_date) ]  <- 1
project4.split$sametime.fcmd[is.na(project4.split$sametime.fcmd)] <- 0    
detach(project4.split)      

project4.split <- subset(project4.split,sametime.fcmd==0)
...
# # 对时间相同的不同阶段进行处理
# 死于首次CMD
project4.split$c_ep0003_date[project4.split$sametime==1] <- project4.split$du_ep0001_date[project4.split$sametime==1] - 0.5/365.25
project4.split$c_ep0008_date[project4.split$sametime==1] <- project4.split$du_ep0001_date[project4.split$sametime==1] - 0.5/365.25
project4.split$c_ep0009_date[project4.split$sametime==1] <- project4.split$du_ep0001_date[project4.split$sametime==1] - 0.5/365.25
project4.split$c_ep0088_date[project4.split$sametime==1] <- project4.split$du_ep0001_date[project4.split$sametime==1] - 0.5/365.25
# 首次心血管代谢性疾病时间与共病记录日期相同
project4.split$c_ep0003_date[project4.split$sametime==2] <- project4.split$mltmbd_inc_date[project4.split$sametime==2] - 0.5/365.25
project4.split$c_ep0008_date[project4.split$sametime==2] <- project4.split$mltmbd_inc_date[project4.split$sametime==2] - 0.5/365.25
project4.split$c_ep0009_date[project4.split$sametime==2] <- project4.split$mltmbd_inc_date[project4.split$sametime==2] - 0.5/365.25
project4.split$c_ep0088_date[project4.split$sametime==2] <- project4.split$mltmbd_inc_date[project4.split$sametime==2] - 0.5/365.25
# 死于首次发生共病
...
project4.split$c_ep0003_date[project4.split$sametime==4] <- project4.split$mltmbd_inc_date[project4.split$sametime==4] - 0.5/365.25
project4.split$c_ep0008_date[project4.split$sametime==4] <- project4.split$mltmbd_inc_date[project4.split$sametime==4] - 0.5/365.25
project4.split$c_ep0009_date[project4.split$sametime==4] <- project4.split$mltmbd_inc_date[project4.split$sametime==4] - 0.5/365.25
project4.split$c_ep0088_date[project4.split$sametime==4] <- project4.split$mltmbd_inc_date[project4.split$sametime==4] - 0.5/365.25

# # # 剔除同时进入的人(挪到下面了)
# project4.split <- subset(project4.split, sametime == 0 & sametime.fcmd == 0 & sametime.hs == 0) 

# 仅保留需要的变量
mltstate.origin.split <- subset(project4.split, select = varlist, sametime.fcmd == 0)  
# 生成代表进入研究的阶段
...
mltstate.long.split <- msprep(data = mltstate.origin.split, trans = tmat.split,
                        ...
                        keep = c(covariates,lifestyles,"first_cmd_inc","mltmbd_inc","c_ep0003", "c_ep0009", "c_ep0008", "c_ep0088", "mltmbd_inc", "du_ep0001",
                                 "c_ep0003_date", "c_ep0009_date", "c_ep0008_date", "c_ep0088_date", "mltmbd_inc_date", "du_ep0001_date"),
...
# Comment 提出的意见
# Transition Pattern B
total <- ddply(mltstate.final.split,c("trans"),summarise,a1=sum(status),b1=sum(time),c1=sum(status)/sum(time)*10000)
total[,5] <- "total"
colnames(total)[5] <- "name"
total.a <- dcast(total,name~trans,value.var = "a1")
total.b <- dcast(total,name~trans,value.var = "c1")

temp1 <- ddply(mltstate.final.split,c("trans","risky_smoking"),summarise,a1=sum(status),b1=sum(time),c1=sum(status)/sum(time)*10000)
colnames(temp1)[2] <- "name"
temp1.a <- dcast(temp1,name~trans,value.var = "a1")
temp1.b <- dcast(temp1,name~trans,value.var = "c1")

temp2 <- ddply(mltstate.final.split,c("trans","risky_alcohol"),summarise,a2=sum(status),b2=sum(time),c2=sum(status)/sum(time)*10000)
colnames(temp2)[2] <- "name"
temp2.a <- dcast(temp2,name~trans,value.var = "a2")
temp2.b <- dcast(temp2,name~trans,value.var = "c2")

temp3 <- ddply(mltstate.final.split,c("trans","risky_diet"),summarise,a3=sum(status),b3=sum(time),c3=sum(status)/sum(time)*10000)
colnames(temp3)[2] <- "name"
temp3.a <- dcast(temp3,name~trans,value.var = "a3")
temp3.b <- dcast(temp3,name~trans,value.var = "c3")

temp4 <- ddply(mltstate.final.split,c("trans","risky_obesity"),summarise,a4=sum(status),b4=sum(time),c4=sum(status)/sum(time)*10000)
colnames(temp4)[2] <- "name"
temp4.a <- dcast(temp4,name~trans,value.var = "a4")
temp4.b <- dcast(temp4,name~trans,value.var = "c4")

temp5 <- ddply(mltstate.final.split,c("trans","risky_PA"),summarise,a5=sum(status),b5=sum(time),c5=sum(status)/sum(time)*10000)
colnames(temp5)[2] <- "name"
temp5.a <- dcast(temp5,name~trans,value.var = "a5")
temp5.b <- dcast(temp5,name~trans,value.var = "c5")

temp6 <- ddply(mltstate.final.split,c("trans","rscore.cat"),summarise,a6=sum(status),b6=sum(time),c6=sum(status)/sum(time)*10000)
colnames(temp6)[2] <- "name"
temp6.a <- dcast(temp6,name~trans,value.var = "a6")
temp6.b <- dcast(temp6,name~trans,value.var = "c6")

a <- rbind(temp1.a,temp2.a,temp3.a,temp4.a,temp5.a,temp6.a,total.a)
write.csv(a, "D:/HanYT/2019-06 Multimorbidity/3. Result/multistate/For comment/transition pattern B No. case.csv")
b <- rbind(temp1.b,temp2.b,temp3.b,temp4.b,temp5.b,temp6.b,total.b)
write.csv(b, "D:/HanYT/2019-06 Multimorbidity/3. Result/multistate/For comment/transition pattern B incidence.csv")