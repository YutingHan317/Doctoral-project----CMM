...
project4.diff$first_cmd_inc_date <- as.numeric(project4.diff$first_cmd_inc_date1)
project4.diff$mltmbd_inc_date <- as.numeric(project4.diff$mltmbd_inc_date1)
...
project4.diff$first_cmd_inc <- as.numeric(project4.diff$first_cmd_inc1)
project4.diff$mltmbd_inc <- as.numeric(project4.diff$mltmbd_inc1)
...
singlediff.hr2[,5] <- paste0(sprintf(singlediff.hr2[,1],fmt="%.2f")," (",sprintf(singlediff.hr2[,3],fmt="%.2f"),"-",sprintf(singlediff.hr2[,4],fmt="%.2f"),")")
...
scorecatdiff.hr2[,5] <- paste0(sprintf(scorecatdiff.hr2[,1],fmt="%.2f")," (",sprintf(scorecatdiff.hr2[,3],fmt="%.2f"),"-",sprintf(scorecatdiff.hr2[,4],fmt="%.2f"),")")
...
scoreorddiff.hr2[,5] <- paste0(sprintf(scoreorddiff.hr2[,1],fmt="%.2f")," (",sprintf(scoreorddiff.hr2[,3],fmt="%.2f"),"-",sprintf(scoreorddiff.hr2[,4],fmt="%.2f"),")")
