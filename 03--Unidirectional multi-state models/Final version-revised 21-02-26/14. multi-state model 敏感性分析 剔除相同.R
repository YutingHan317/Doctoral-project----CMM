...
project4.drop$first_cmd_inc_date <- as.numeric(project4.drop$first_cmd_inc_date1)
project4.drop$mltmbd_inc_date <- as.numeric(project4.drop$mltmbd_inc_date1)
...
project4.drop$first_cmd_inc <- as.numeric(project4.drop$first_cmd_inc1)
project4.drop$mltmbd_inc <- as.numeric(project4.drop$mltmbd_inc1)
