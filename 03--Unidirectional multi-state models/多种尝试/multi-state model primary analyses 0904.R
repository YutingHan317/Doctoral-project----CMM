...
###################################                                                           ##################################################
################################################################################################################################################
path <- paste("3. Result/multistate/Subgroup analyses/",Sys.Date())
dir.create(path)
##########################################          无交互项基础模型        ##########################################
# scoreord2
...
# interaction
score.vector <- paste0("hscore",".",1:5)
...
subgroup.interaction <- rbind(scoreord.sex.interaction,scoreord.age.interaction,scoreord.residence.interaction,scoreord.edu.interaction,scoreord.fhd.interaction)
