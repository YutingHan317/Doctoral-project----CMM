...
newd1 <- data.frame(is_female = rep(0.5898,no_trans), marital_status_2groups = rep(0.0891,no_trans),
                    age_strata135 = rep(0,no_trans), age_strata140 = rep(0,no_trans), age_strata145 = rep(0,no_trans), 
                    age_strata150 = rep(0,no_trans), age_strata155 = rep(0,no_trans), age_strata160 = rep(0,no_trans),
                    age_strata165 = rep(0,no_trans), age_strata170 = rep(0,no_trans), age_strata175 = rep(0,no_trans),
