...
project4.2y$first_cmd_inc_date <- as.numeric(project4.2y$first_cmd_inc_date)
project4.2y$mltmbd_inc_date <- as.numeric(project4.2y$mltmbd_inc_date)
...
single.hr2.2y[,5] <- paste0(as.character(single.hr2.2y[,1])," (",single.hr2.2y[,3],"-",single.hr2.2y[,4],")")
...
scorecat.hr2.2y[,5] <- paste0(as.character(scorecat.hr2.2y[,1])," (",scorecat.hr2.2y[,3],"-",scorecat.hr2.2y[,4],")")
...
scoreord.hr2.2y[,5] <- paste0(as.character(scoreord.hr2.2y[,1])," (",scoreord.hr2.2y[,3],"-",scoreord.hr2.2y[,4],")")
