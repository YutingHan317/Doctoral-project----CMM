...
mltstate.long.diff$hscore <- mltstate.long.diff$healthy_score_5groups1
mltstate.long.diff$hscore.cat <- as.factor(mltstate.long.diff$hscore)
...
write.csv(singlediff.hr2, paste0("3. Result/multistate/sensitivity analyses diff enter stage/dichotomous single",Sys.Date(),".csv",sep = " "))
...
write.csv(scorecatdiff.hr2, paste0("3. Result/multistate/sensitivity analyses diff enter stage/category score",Sys.Date(),".csv",sep = " "))
...
write.csv(scoreorddiff.hr2, paste0("3. Result/multistate/sensitivity analyses diff enter stage/ordinal score",Sys.Date(),".csv",sep = " "))
