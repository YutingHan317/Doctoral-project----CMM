...
# 设置路径
tmat <- transMat(x = list(c(2,3,4), c(3,4), c(4), c()), names = c("healthy", "fcmd", "mltmbd", "Death"))

# Wide to long
mltstate.long.trans <- msprep(data = mltstate.origin.trans, trans = tmat,
...
scorecat.hr2.trans <- scorecat.hr2.trans[(nrow(scorecat.hr2.trans)-19):nrow(scorecat.hr2.trans),]
