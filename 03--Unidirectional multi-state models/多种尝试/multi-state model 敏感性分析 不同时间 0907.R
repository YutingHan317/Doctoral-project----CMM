...
covariates <- c("studyid","age_strata","region_code","region_is_urban","is_female","highest_education","occupation",
                "marital_status","household_income","parental_fh_3groups", "chronic_fh", "mltmbd_fh_3groups", "menopause_2groups",
...
for (i in 1:5){
    ...
    long_covariates <- c("is_female","highest_education","occupation","marital_status","mltmbd_fh_3groups","menopause_2groups",
                         "age_3groups","region_is_urban", "education_3groups")
    ...
    singlesen.hr2[,5] <- paste0(as.character(singlesen.hr2[,1])," (",singlesen.hr2[,3],"-",singlesen.hr2[,4],")")
    ...
    scorecatsen.hr2[,5] <- paste0(as.character(scorecatsen.hr2[,1])," (",scorecatsen.hr2[,3],"-",scorecatsen.hr2[,4],")")
    ...
    scoreordsen.hr2[,5] <- paste0(scoreordsen.hr2[,1]," (",scoreordsen.hr2[,3],"-",scoreordsen.hr2[,4],")")
