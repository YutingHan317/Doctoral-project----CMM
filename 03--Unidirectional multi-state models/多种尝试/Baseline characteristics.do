...
gen table1_category = 1 if d_number_inc == 0 & du_ep0001 == 0
	replace table1_category = 2 if d_number_inc == 1 & du_ep0001 == 0
	replace table1_category = 3 if d_number_inc >  1 & du_ep0001 == 0
	replace table1_category = 4 if d_number_inc == 0 & du_ep0001 == 1
	replace table1_category = 5 if d_number_inc == 1 & du_ep0001 == 1
	replace table1_category = 6 if d_number_inc >  1 & du_ep0001 == 1
tab table1_category
keep if is_female == 0
tempname stats
tempfile table1
