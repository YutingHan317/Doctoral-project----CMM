...
lifestyles <- c("healthy_smoking","healthy_alcohol","healthy_diet","healthy_bmi","healthy_WC","healthy_sleep","healthy_PA","healthy_score_5groups","healthy_score",
                "risky_smoking","risky_alcohol","risky_diet","risky_bmi","risky_WC","risky_sleep","risky_PA","risk_obesity","risky_score_5groups","risky_score")
...
long_lf <- c("healthy_smoking","healthy_alcohol","healthy_diet","healthy_bmi","healthy_WC","healthy_sleep","healthy_PA","hscore","hscore.cat",
             "risky_smoking","risky_alcohol","risky_diet","risky_bmi","risky_WC","risky_sleep","risk_obesity","risky_PA","rscore","rscore.cat")
...
ddply(mltstate.final,c("risky_bmi","trans"),summarise,a=sum(status))
ddply(mltstate.final,c("risky_WC","trans"),summarise,a=sum(status))
...
# interaction
score.vector <- paste0("rscore",".",1:5)
...
for (i in 1:5){
    ...
    scoreord.sexlist[[i]] <- coxph(Surv(Tstart, Tstop, status) ~ strata(trans)+ strata(region_code) + strata(age_strata) +
                                       ...
                                       as.factor(mltmbd_fh_3groups.1) + as.factor(mltmbd_fh_3groups.2) + as.factor(mltmbd_fh_3groups.3) + as.factor(mltmbd_fh_3groups.4) + as.factor(mltmbd_fh_3groups.5) + 
                                       rscore.1 + rscore.2 + rscore.3 + rscore.4 + rscore.5 + 
                                       mltstate.final[,sex.vector[i]]:mltstate.final[,score.vector[i]],
                                   data = mltstate.final, method = "breslow")
    ...
    interaction <- lrtest(scoreord2,scoreord.sexlist[[i]])
...
for (i in 1:5){
    ...
    scoreord.agelist[[i]] <- coxph(Surv(Tstart, Tstop, status) ~ strata(trans)+ strata(region_code) + strata(age_strata) +
                                       ...
                                       as.factor(mltmbd_fh_3groups.1) + as.factor(mltmbd_fh_3groups.2) + as.factor(mltmbd_fh_3groups.3) + as.factor(mltmbd_fh_3groups.4) + as.factor(mltmbd_fh_3groups.5) + 
                                       rscore.1 + rscore.2 + rscore.3 + rscore.4 + rscore.5 + 
                                       as.factor(mltstate.final[,age.vector[i]]):mltstate.final[,score.vector[i]],
                                   data = mltstate.final, method = "breslow")
    ...
    interaction <- lrtest(scoreord2,scoreord.agelist[[i]])
...
for (i in 1:5){
    ...
    scoreord.residencelist[[i]] <- coxph(Surv(Tstart, Tstop, status) ~ strata(trans)+ strata(region_code) + strata(age_strata) +
                                       ...
                                       as.factor(mltmbd_fh_3groups.1) + as.factor(mltmbd_fh_3groups.2) + as.factor(mltmbd_fh_3groups.3) + as.factor(mltmbd_fh_3groups.4) + as.factor(mltmbd_fh_3groups.5) + 
                                       rscore.1 + rscore.2 + rscore.3 + rscore.4 + rscore.5 + 
                                       as.factor(mltstate.final[,residence.vector[i]]):mltstate.final[,score.vector[i]],
                                   data = mltstate.final, method = "breslow")
    ...
    interaction <- lrtest(scoreord2,scoreord.residencelist[[i]])
...
for (i in 1:5){
    ...
    scoreord.edulist[[i]] <- coxph(Surv(Tstart, Tstop, status) ~ strata(trans)+ strata(region_code) + strata(age_strata) +
                                       ...
                                       as.factor(mltmbd_fh_3groups.1) + as.factor(mltmbd_fh_3groups.2) + as.factor(mltmbd_fh_3groups.3) + as.factor(mltmbd_fh_3groups.4) + as.factor(mltmbd_fh_3groups.5) + 
                                       rscore.1 + rscore.2 + rscore.3 + rscore.4 + rscore.5 + 
                                       as.factor(mltstate.final[,edu.vector[i]]):mltstate.final[,score.vector[i]],
                                   data = mltstate.final, method = "breslow")
    ...
    interaction <- lrtest(scoreord2,scoreord.edulist[[i]])
...
# interaction
fhd.vector <- paste0("mltmbd_fh_3groups",".",1:5)
...
for (i in 1:5){
    ...
    scoreord.fhdlist[[i]] <- coxph(Surv(Tstart, Tstop, status) ~ strata(trans)+ strata(region_code) + strata(age_strata) +
                                       ...
                                       as.factor(mltmbd_fh_3groups.1) + as.factor(mltmbd_fh_3groups.2) + as.factor(mltmbd_fh_3groups.3) + as.factor(mltmbd_fh_3groups.4) + as.factor(mltmbd_fh_3groups.5) + 
                                       rscore.1 + rscore.2 + rscore.3 + rscore.4 + rscore.5 + 
                                       as.factor(mltstate.final[,fhd.vector[i]]):mltstate.final[,score.vector[i]],
                                   data = mltstate.final, method = "breslow")
    ...
    interaction <- lrtest(scoreord2,scoreord.fhdlist[[i]])
...
scoreord.ht1.hr[,5] <- paste0(as.character(scoreord.ht1.hr[,1])," (",scoreord.ht1.hr[,3],"-",scoreord.ht1.hr[,4],")")
...
scoreord.ht0.hr[,5] <- paste0(as.character(scoreord.ht0.hr[,1])," (",scoreord.ht0.hr[,3],"-",scoreord.ht0.hr[,4],")")
...
mltstate.subgroups <- rbind(scoreord.men.hr,scoreord.women.hr,scoreord.lt50.hr,scoreord.5059.hr,scoreord.ge60.hr,
                            ...
                            scoreord.none.hr,scoreord.one.hr,scoreord.multi.hr,scoreord.ht1.hr,scoreord.ht0.hr)
