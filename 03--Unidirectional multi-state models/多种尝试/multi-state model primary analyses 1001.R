...
mltstate.none <- subset(mltstate.final, parental_fh_3groups == 0)
mltstate.one <- subset(mltstate.final, parental_fh_3groups == 1)
mltstate.multi <- subset(mltstate.final, parental_fh_3groups == 2)
...
# interaction
fhd.vector <- paste0("parental_fh_3groups",".",1:5)
